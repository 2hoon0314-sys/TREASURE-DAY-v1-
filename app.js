...
function openTreasureBadgeDetail(badgeId) {

  const badge =
    treasureBadgeDefinitions.find(
  ...
  modal.innerHTML = `
    <div class="treasure-badge-detail-card">

      <button
        type="button"
        class="treasure-badge-detail-close"
      >
        ×
      </button>

      <div class="treasure-badge-detail-icon">
        ${unlocked ? badge.icon : "🔒"}
      </div>
      ...
      <div class="treasure-badge-detail-info">
  ...
  .forEach(card => {
    ...
    card.addEventListener(
      ...
      () => {
        ...
        openTreasureBadgeDetail(
          card.dataset.badgeId
        );
...
const treasureCalendarStorageKey =
  "treasure-calendar-events";

let treasureCalendarEvents = [];
...
// 選択中の日付
let treasureCalendarSelectedKey = "";


// FORM DOM
const treasureCalendarAddEvent =
  document.getElementById(
    "treasure-calendar-add-event"
  );

const treasureCalendarForm =
  document.getElementById(
    "treasure-calendar-form"
  );

const treasureCalendarFormCancel =
  document.getElementById(
    "treasure-calendar-form-cancel"
  );

const treasureCalendarFormSave =
  document.getElementById(
    "treasure-calendar-form-save"
  );

const treasureCalendarEventTitle =
  document.getElementById(
    "treasure-calendar-event-title"
  );

const treasureCalendarEventTime =
  document.getElementById(
    "treasure-calendar-event-time"
  );

const treasureCalendarEventCategory =
  document.getElementById(
    "treasure-calendar-event-category"
  );

const treasureCalendarEventMemo =
  document.getElementById(
    "treasure-calendar-event-memo"
  );

const treasureCalendarEventList =
  document.getElementById(
    "treasure-calendar-event-list"
  );
...
function saveTreasureCalendarEvents() {
...
function makeTreasureCalendarDateKey(
  year,
  month,
  day
) {
...
function renderTreasureCalendarDayEvents() {

  if (!treasureCalendarEventList) {
    return;
  }

  treasureCalendarEventList.innerHTML =
    "";
  ...
  if (events.length === 0) {
    ...
    treasureCalendarEventList.innerHTML =
      `
        <div class="treasure-calendar-event-card">
          <strong>予定なし 💎</strong>
          <small>
            ＋ ADD SCHEDULE から追加できます
          </small>
        </div>
      `;
...
if (treasureCalendarAddEvent) {

  treasureCalendarAddEvent.addEventListener(
    "click",
    () => {

      if (!treasureCalendarForm) {
        return;
      }
...
if (treasureCalendarFormCancel) {

  treasureCalendarFormCancel.addEventListener(
    "click",
    () => {
...
if (treasureCalendarFormSave) {

  treasureCalendarFormSave.addEventListener(
    "click",
    () => {

      const title =
        treasureCalendarEventTitle
          ? treasureCalendarEventTitle
              .value
              .trim()
          : "";
      ...
      if (!treasureCalendarSelectedKey) {
